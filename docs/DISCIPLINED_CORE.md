# 🛡️ rat Disciplined Core Specification
...
All priority levels are validated by `hard_rules_gate::tests` in `rat-autonomous`:
...
Run: `cargo test --package rat-autonomous hard_rules_gate::tests`
