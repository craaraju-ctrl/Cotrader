//! # rat HTTP Server — Production Trading Backend
//!
...
//! ## Run
//! ```bash
//! cargo run -p rat-server -- --port 8080
//! ```
...
async fn main() {
    ...
    log::info!("[rat Server] Starting production trading backend...");
    ...
    log::info!("[rat Server] Listening on http://{}", addr);
