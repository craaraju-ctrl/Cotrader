//! compliance_officer Memory — Agent-specific memory connection.

use agentic_memory::client::MemoryClient;

pub struct compliance_officerMemory {
    client: MemoryClient,
    namespace: String,
}

impl compliance_officerMemory {
    pub fn new(base_url: &str) -> Self {
        Self {
            client: MemoryClient::new(base_url),
            namespace: "compliance_officer".to_string(),
        }
    }
