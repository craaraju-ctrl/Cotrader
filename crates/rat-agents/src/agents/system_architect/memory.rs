//! system_architect Memory — Agent-specific memory connection.

use agentic_memory::client::MemoryClient;

pub struct system_architectMemory {
    client: MemoryClient,
    namespace: String,
}

impl system_architectMemory {
    pub fn new(base_url: &str) -> Self {
        Self {
            client: MemoryClient::new(base_url),
            namespace: "system_architect".to_string(),
        }
    }
