//! quant_researcher Memory — Agent-specific memory connection.

use agentic_memory::client::MemoryClient;

pub struct quant_researcherMemory {
    client: MemoryClient,
    namespace: String,
}

impl quant_researcherMemory {
    pub fn new(base_url: &str) -> Self {
        Self {
            client: MemoryClient::new(base_url),
            namespace: "quant_researcher".to_string(),
        }
    }
