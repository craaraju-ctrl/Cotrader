//! fundamental_analyst Memory — Agent-specific memory connection.

use agentic_memory::client::MemoryClient;

pub struct fundamental_analystMemory {
    client: MemoryClient,
    namespace: String,
}

impl fundamental_analystMemory {
    pub fn new(base_url: &str) -> Self {
        Self {
            client: MemoryClient::new(base_url),
            namespace: "fundamental_analyst".to_string(),
        }
    }
