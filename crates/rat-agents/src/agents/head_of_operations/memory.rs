//! head_of_operations Memory — Agent-specific memory connection.

use agentic_memory::client::MemoryClient;

pub struct head_of_operationsMemory {
    client: MemoryClient,
    namespace: String,
}

impl head_of_operationsMemory {
    pub fn new(base_url: &str) -> Self {
        Self {
            client: MemoryClient::new(base_url),
            namespace: "head_of_operations".to_string(),
        }
    }
