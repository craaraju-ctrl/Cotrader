//! sentiment_analyst Memory — Agent-specific memory connection.

use agentic_memory::client::MemoryClient;

pub struct sentiment_analystMemory {
    client: MemoryClient,
    namespace: String,
}

impl sentiment_analystMemory {
    pub fn new(base_url: &str) -> Self {
        Self {
            client: MemoryClient::new(base_url),
            namespace: "sentiment_analyst".to_string(),
        }
    }
