//! head_of_research Memory — Agent-specific memory connection.

use agentic_memory::client::MemoryClient;

pub struct head_of_researchMemory {
    client: MemoryClient,
    namespace: String,
}

impl head_of_researchMemory {
    pub fn new(base_url: &str) -> Self {
        Self {
            client: MemoryClient::new(base_url),
            namespace: "head_of_research".to_string(),
        }
    }
