//! technical_analyst Memory — Agent-specific memory connection.

use agentic_memory::client::MemoryClient;

pub struct technical_analystMemory {
    client: MemoryClient,
    namespace: String,
}

impl technical_analystMemory {
    pub fn new(base_url: &str) -> Self {
        Self {
            client: MemoryClient::new(base_url),
            namespace: "technical_analyst".to_string(),
        }
    }
