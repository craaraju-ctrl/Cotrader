//! market_risk_manager Memory — Agent-specific memory connection.

use agentic_memory::client::MemoryClient;

pub struct market_risk_managerMemory {
    client: MemoryClient,
    namespace: String,
}

impl market_risk_managerMemory {
    pub fn new(base_url: &str) -> Self {
        Self {
            client: MemoryClient::new(base_url),
            namespace: "market_risk_manager".to_string(),
        }
    }
