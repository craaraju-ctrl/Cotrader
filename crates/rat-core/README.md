...
Foundation crate for the rat autonomous trading system.
...
```rust
use rat_core::DisciplinedCore;
use rat_core::skills::AgentSkill;
use rat_core::paper_engine::BrokerAdapter;
```

This crate is a dependency of `rat-autonomous`, `rat-orchestrator`, `rat-tui`, `rat-server`, `rat-runtime`, `rat-broker-alpaca`, and `rat-broker-zerodha`.
