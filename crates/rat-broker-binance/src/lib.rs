...
impl BinanceBroker {
    ...
    pub fn new(api_key: &str, secret_key: &str, testnet: bool) -> Self {
        ...
        let client = reqwest::Client::builder()
            .user_agent("rat/0.2.0 (Binance Spot API)")
    ...
    /// Map RAT OrderType to Binance order type string.
    ...
    /// Map RAT TradeDirection to Binance side.
    ...
    /// Parse Binance order status to RAT OrderStatus.
    ...
    /// Convert balances from account info into RAT Positions.
