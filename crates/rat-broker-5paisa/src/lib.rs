...
impl FivePaisaBroker {
    ...
    pub fn new(
        ...
        let client = reqwest::Client::builder()
            .user_agent("rat/0.2.0 (5Paisa Xstream API)")
    ...
    /// Map RAT OrderType to 5Paisa order type string.
    ...
    /// Map RAT direction to 5Paisa Buy/Sell.
...
impl BrokerAdapter for FivePaisaBroker {
    ...
    async fn place_order(
        ...
        let remote_order_id = request
            .client_order_id
            .clone()
            .or_else(|| Some(format!("rat_{}", chrono::Utc::now().timestamp_millis())));
