...
The intelligence layer of the rat trading system — agent hierarchy, debate, skills, and temporal pipeline.
...
| Module | Purpose |
|--------|---------|
| `rat.rs` | Rat orchestrator with Identifier/Verifier/Executer/Guardian groups |
...
```rust
use rat_autonomous::debate::DebateCoordinator;
