...
use rat_autonomous::episode_store::{ClosedEpisode, EpisodeStore, RuleSnapshot};
use rat_autonomous::meta_control::EvolvedMetaControl;
use rat_autonomous::outcome_processor::{OutcomeProcessor, PreTradeSnapshot};
use rat_autonomous::risk_guardian::RiskGuardianConfig;
...
async fn test_automated_rule_revert_on_degraded_performance() {
    ...
    let weight_tuner = rat_autonomous::weight_tuner::AttributionEngine::new(0.10);
