...
//
// Run: cargo test -p rat-autonomous --test debug_100_trades -- --nocapture

use chrono::Utc;
use std::collections::HashMap;
use std::fs;
use rat_autonomous::types::{MarketRegime, OpenPosition};
...
async fn debug_100_trades_blocking_points() {
    ...
    *orch.state.market_regime.write().await = Some(MarketRegime::TrendingBull);
    ...
    println!("       - crates/rat-autonomous/src/hard_rules_gate.rs");
    println!("       - crates/rat-autonomous/src/debate_layer.rs");
    println!("       - crates/rat-autonomous/src/orchestrator_pipeline.rs");
