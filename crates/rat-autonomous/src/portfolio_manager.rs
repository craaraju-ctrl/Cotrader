...
use chrono::Utc;
use std::error::Error;
use rat_core::{Agent, AgentInput, AgentOutput, AgentTier};
    ...
    pub async fn close_position(
            ...
            .position(|p| p.symbol == symbol)
        {
            ...
            let realized_pnl = match pos.direction {
                rat_core::TradeDirection::Long => (exit_price - pos.entry_price) * pos.quantity,
                rat_core::TradeDirection::Short => (pos.entry_price - exit_price) * pos.quantity,
            };
