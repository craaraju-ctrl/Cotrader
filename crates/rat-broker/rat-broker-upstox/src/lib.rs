...
impl UpstoxBroker {
    ...
    pub fn new(
        ...
        let client = reqwest::Client::builder()
            .user_agent("rat/0.2.0 (Upstox API v2)")
    ...
    /// Map RAT OrderType to Upstox order type string.
    ...
    /// Map RAT TradeDirection to Upstox transaction type.
    ...
    /// Map Upstox order status to RAT OrderStatus.
