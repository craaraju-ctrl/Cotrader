...
use cotrader_autonomous::episode_store::{ClosedEpisode, EpisodeStore, RuleSnapshot};
use cotrader_autonomous::meta_control::EvolvedMetaControl;
use cotrader_autonomous::outcome_processor::{OutcomeProcessor, PreTradeSnapshot};
use cotrader_autonomous::risk_guardian::RiskGuardianConfig;
...
async fn test_automated_rule_revert_on_degraded_performance() {
    ...
    let weight_tuner = cotrader_autonomous::weight_tuner::AttributionEngine::new(0.10);
