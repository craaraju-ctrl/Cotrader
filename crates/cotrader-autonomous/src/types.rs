...
// Re-export MarketRegime from rat-core to avoid circular dependencies
pub use cotrader_core::MarketRegime;
...
pub struct OhlcvSnapshot {
    pub symbol: String,
    pub bars: Vec<cotrader_core::OhlcvBar>,
...
impl OhlcvSnapshot {
    ...
    pub fn bars(&self) -> &[cotrader_core::OhlcvBar] {
        &self.bars
    }
}
